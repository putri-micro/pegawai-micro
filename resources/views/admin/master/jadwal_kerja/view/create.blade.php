    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="fw-bolder">Tambah Jadwal Kerja</h2>
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="number" name="toleransi_menit" id="toleransi_menit" min="0" value="0"
                                class="form-control form-control-solid mb-3 mb-lg-0" required />
                        </div>

                        <div class="fv-row mb-7">
                            <label class="fw-bold fs-6 mb-2">Nama Libur</label>
                            <select name="id_libur" id="id_libur" class="form-select form-select-solid"
