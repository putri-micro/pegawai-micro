        ...
        <form method="post" id="bt_submit_edit">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Libur</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <select data-control="select2" id="edit_jenis_libur"
                        ...
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" id="edit_nama_libur"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" required>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <textarea id="edit_keterangan" class="form-control form-control-sm fs-sm-8 fs-lg-6"
                                    rows="3"></textarea>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
