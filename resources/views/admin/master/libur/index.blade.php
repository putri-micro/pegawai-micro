...
@section('list')
    ...
    <li class="breadcrumb-item text-dark">Libur</li>
@endsection
...
@section('content')
            ...
            <div class="card mb-xl-8 mb-5 border-2 shadow">
                <div class="card-header">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder mb-1">Data Master Libur</span>
                    </h3>
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <a type="button" class="btn btn-sm btn-primary fs-sm-8 fs-lg-6" data-bs-toggle="modal"
                                data-bs-target="#form_create" title="Tambah Libur">Tambah Libur</a>
                        </div>
                    </div>
                </div>
                <div class="card-body p-5">
                    <div
                        ...
                        <div class="d-flex flex-stack fs-sm-8 fs-lg-6">
                            <div class="row">
                                <span class="text-gray-700">Berikut ini adalah data hari libur (Nasional dan
                                    Perusahaan).</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="example"
                            ...
                            <thead>
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0 fs-sm-8 fs-lg-6">
                                    ...
                                    <th class="min-w-100px">Jenis Libur</th>
                                    <th class="min-w-150px">Nama Libur</th>
    ...
    @include('admin.master.libur.view.detail')
    @include('admin.master.libur.view.create')
    @include('admin.master.libur.view.edit')
@endsection
...
@section('javascript')
    ...
    @include('admin.master.libur.script.list')
    @include('admin.master.libur.script.create')
    @include('admin.master.libur.script.edit')
    @include('admin.master.libur.script.detail')
@endsection