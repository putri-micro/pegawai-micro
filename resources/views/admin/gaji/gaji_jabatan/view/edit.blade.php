    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="fw-bolder">Edit Gaji Jabatan</h2>
                ...
                <form id="form_edit_data" class="form" action="#">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="modal_edit_scroll" data-kt-scroll="true"
                        ...
                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">ID Master Gaji</label>
                            <input type="text" name="gaji_master_id" id="gaji_master_id_edit"
                                class="form-control form-control-solid mb-3 mb-lg-0" placeholder="ID Master Gaji" />
                        </div>
