                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <a type="button" class="btn btn-sm btn-primary fs-sm-8 fs-lg-6" data-bs-toggle="modal"
                                data-bs-target="#form_create" title="Tambah Tarif Lembur">Tambah Tarif Lembur</a>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="example"
                            ...
                            <thead>
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0 fs-sm-8 fs-lg-6">
                                    ...
                                    <th class="min-w-100px">ID Tarif</th>
                                    <th class="min-w-150px">Jenis Lembur</th>
                                    <th class="min-w-150px">Tarif per Jam</th>
                                    <th class="min-w-150px">Berlaku Mulai</th>
                                </tr>
                            </thead>
