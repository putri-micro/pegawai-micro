                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <a type="button" class="btn btn-sm btn-primary fs-sm-8 fs-lg-6" data-bs-toggle="modal"
                                data-bs-target="#form_create" title="Tambah Tarif Potongan">Tambah Tarif Potongan</a>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="example"
                            ...
                            <thead>
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0 fs-sm-8 fs-lg-6">
                                    ...
                                    <th class="min-w-100px">ID Potongan</th>
                                    <th class="min-w-150px">Nama Potongan</th>
                                    <th class="min-w-150px">Tarif per Kejadian</th>
