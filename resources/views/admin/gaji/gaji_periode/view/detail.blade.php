    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="fw-bolder">Detail Gaji Periode</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="modal_detail_scroll" data-kt-scroll="true"
                    ...
                    <div class="fv-row mb-7">
                        <label class="fw-bold fs-6 mb-2">Tahun</label>
                        <div id="tahun_detail" class="text-gray-800 fs-6 fw-bolder"></div>
                    </div>
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <div id="status_detail" class="text-gray-800 fs-6 fw-bolder"></div>
                    </div>
