    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="fw-bolder">Edit Gaji Periode</h2>
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="modal_edit_scroll" data-kt-scroll="true"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="periode_id" id="periode_id_edit"
                                class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Contoh: 202401" />
                        </div>

                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">Tahun</label>
                            <input type="number" name="tahun" id="tahun_edit"
                                class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Contoh: 2024" />
                        </div>

                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">Tanggal Mulai</label>
                            <input type="date" name="tanggal_mulai" id="tanggal_mulai_edit"
                                class="form-control form-control-solid mb-3 mb-lg-0" />
                        </div>

                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">Tanggal Selesai</label>
                            <input type="date" name="tanggal_selesai" id="tanggal_selesai_edit"
                                class="form-control form-control-solid mb-3 mb-lg-0" />
                        </div>

                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">Status</label>
                            <select name="status" id="status_edit" class="form-select form-select-solid"
