<script>
                        ...
                        if (o) {
                            o.validate().then((function (t) {
                                if ("Valid" == t) {
                                    ...
                                    $.ajax({
                                        url: "{{ route('admin.gaji.gaji_umum.update', ':id') }}".replace(':id', id),
                                        type: "POST",
                                        data: formData,
                                        processData: false,
                                        contentType: false,
    ...
    KTUtil.onDOMContentLoaded((function () { KTGajiUmumEdit.init() }));
    ...
    function deleteData(id) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{{ route('admin.gaji.gaji_umum.destroy', ':id') }}".replace(':id', id),
                    type: "DELETE",
                    headers: { 'X-CSRF-TOKEN': $('meta[name="X-CSRF-TOKEN"]').attr('content') },
                    success: function (response) {
