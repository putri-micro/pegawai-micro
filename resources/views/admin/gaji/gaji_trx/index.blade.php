...
@section('list')
    ...
    <li class="breadcrumb-item text-dark">Gaji Trx</li>
@endsection
            ...
            <div class="card mb-xl-8 mb-5 border-2 shadow">
                <div class="card-header">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder mb-1">Data Gaji Trx</span>
                    </h3>
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <a type="button" class="btn btn-sm btn-primary fs-sm-8 fs-lg-6" data-bs-toggle="modal"
                                data-bs-target="#form_create" title="Tambah Gaji Trx">Tambah Gaji Trx</a>
                        </div>
                    </div>
                </div>
                <div class="card-body p-5">
                    <div
                        ...
                        <div class="d-flex flex-stack fs-sm-8 fs-lg-6">
                            <div class="row">
                                <span class="text-gray-700">Berikut ini adalah data transaksi gaji.</span>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <table id="example"
                            ...
                            <thead>
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0 fs-sm-8 fs-lg-6">
                                    ...
                                    <th class="min-w-100px">ID Periode</th>
                                    <th class="min-w-125px">Total Penghasilan</th>
                                    <th class="min-w-125px">Total Potongan</th>
                                    <th class="min-w-125px">Total Dibayar</th>
                                </tr>
                            </thead>
