    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="fw-bolder">Tambah Gaji Trx</h2>
                ...
                <form id="form_create_data" class="form" action="#">
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="modal_create_scroll" data-kt-scroll="true"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="number" name="total_penghasil"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="number" name="total_potongan"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="number" name="total_dibayar"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="number" name="id_sdm" class="form-control form-control-solid mb-3 mb-lg-0"
                                placeholder="ID SDM" />
                        </div>
