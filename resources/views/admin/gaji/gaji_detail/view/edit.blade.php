    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="fw-bolder">Edit Gaji Detail</h2>
                ...
                <form id="form_edit_data" class="form" action="#">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="modal_edit_scroll" data-kt-scroll="true"
                        ...
                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">ID Detail</label>
                            <input type="text" name="detail_id" id="detail_id_edit"
                                class="form-control form-control-solid mb-3 mb-lg-0" placeholder="ID Detail" />
                        </div>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="keterangan" id="keterangan_edit"
                                class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Keterangan" />
                        </div>

                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">ID Transaksi</label>
                            <input type="text" name="transaksi_id" id="transaksi_id_edit_val"
