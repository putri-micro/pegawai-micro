                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <select data-control="select2" class="form-select form-select-sm"
                                    id="edit_id_jenjang_pendidikan" name="id_jenjang_pendidikan"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" name="nama_sekolah"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="edit_nama_sekolah"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <select data-control="select2" name="status_sekolah"
                                    class="form-select form-select-sm fs-sm-8 fs-lg-6" id="edit_status_sekolah"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" name="nomor_induk"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="edit_nomor_induk"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="number" name="tahun_masuk"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="edit_tahun_masuk"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="number" name="tahun_lulus"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="edit_tahun_lulus"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" name="gelar_akademik"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="edit_gelar_akademik"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" name="bidang_studi"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="edit_bidang_studi"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" name="tanggal_lulus"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="edit_tanggal_lulus"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="number" name="jumlah_semester"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="edit_jumlah_semester"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="number" name="jumlah_sks"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="edit_jumlah_sks"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" name="nomor_ijazah"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="edit_nomor_ijazah"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <select data-control="select2" name="sumber_biaya"
                                    class="form-select form-select-sm fs-sm-8 fs-lg-6" id="edit_sumber_biaya"
                        ...
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" name="nama_pembimbing"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="edit_nama_pembimbing"
                        ...
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <textarea name="judul_tugas_akhir" class="form-control form-control-sm fs-sm-8 fs-lg-6"
                                    rows="3" maxlength="255" id="edit_judul_tugas_akhir"
