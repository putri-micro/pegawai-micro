    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="fw-bolder">Edit Jadwal Karyawan</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <form id="form_edit_data" class="form" action="">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="form_edit_scroll" data-kt-scroll="true"
                        data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                        data-kt-scroll-dependencies="#form_edit_header" data-kt-scroll-wrappers="#form_edit_scroll"
