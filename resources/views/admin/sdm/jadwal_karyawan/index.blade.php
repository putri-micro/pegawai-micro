...
@section('content')
                ...
                <div class="card-toolbar mb-4">
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                            data-bs-target="#form_create" title="Tambah Jadwal">
                            Tambah Jadwal
                        </button>
                    </div>
                </div>
                        ...
                        <table id="example"
                            ...
                            <thead>
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0 fs-sm-8 fs-lg-6">
                                    ...
                                    <th class="min-w-150px">Nama Jadwal</th>
                                    <th class="min-w-120px">Jam Kerja</th>
    ...
    @include('admin.sdm.jadwal_karyawan.view.create')
    @include('admin.sdm.jadwal_karyawan.view.edit')
    @include('admin.sdm.jadwal_karyawan.view.detail')
@endsection
...
@section('javascript')
    ...
    @include('admin.sdm.jadwal_karyawan.script.list')
    @include('admin.sdm.jadwal_karyawan.script.create')
    @include('admin.sdm.jadwal_karyawan.script.edit')
    @include('admin.sdm.jadwal_karyawan.script.delete')
    @include('admin.sdm.jadwal_karyawan.script.detail')
@endsection