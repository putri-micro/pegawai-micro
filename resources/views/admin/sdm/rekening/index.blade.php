                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-4 col-lg-3 mb-3">
                            ...
                            <select data-control="select2" class="form-select form-select-sm fs-sm-8 fs-lg-6"
                                id="list_status_aktif" name="list_status_aktif" data-placeholder="Semua Status"
                        ...
                        <div class="col-md-4 col-lg-3 mb-3">
                            ...
                            <select data-control="select2" class="form-select form-select-sm fs-sm-8 fs-lg-6"
                                id="list_jenis_rekening" name="list_jenis_rekening" data-placeholder="Semua Jenis"
                                data-allow-clear="true">
                                <option></option>
                        ...
                        <div class="col-md-4 col-lg-3 mb-3">
                            ...
                            <select data-control="select2" class="form-select form-select-sm fs-sm-8 fs-lg-6"
                                id="list_rekening_utama" name="list_rekening_utama" data-placeholder="Semua Rekening"
                                data-allow-clear="true">
                                <option></option>
