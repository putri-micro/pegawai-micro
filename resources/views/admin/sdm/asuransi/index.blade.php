                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                            ...
                            <select data-control="select2" class="form-select form-select-sm fs-sm-8 fs-lg-6"
                                id="list_id_jenis_asuransi" name="list_id_jenis_asuransi"
                                data-placeholder="Pilih Jenis Asuransi" data-allow-clear="true">
                            </select>
                        </div>
                        <div class="col-md-6 col-lg-4 mb-3">
                            ...
                            <select data-control="select2" class="form-select form-select-sm fs-sm-8 fs-lg-6"
                                id="list_status" name="list_status" data-placeholder="Pilih Status" data-allow-clear="true">
