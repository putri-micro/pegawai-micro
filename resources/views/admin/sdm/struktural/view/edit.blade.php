                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                <label
                                    class="required d-flex align-items-center fs-sm-8 fs-lg-6 fw-bolder mb-1">Unit</label>
                                <select data-control="select2" class="form-select form-select-sm" id="edit_id_unit"
                                    name="id_unit" data-placeholder="Pilih Unit" data-allow-clear="true">
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                <label
                                    class="required d-flex align-items-center fs-sm-8 fs-lg-6 fw-bolder mb-1">Jabatan</label>
                                <select data-control="select2" class="form-select form-select-sm" id="edit_id_jabatan"
                                    name="id_jabatan" data-placeholder="Pilih Jabatan" data-allow-clear="true" disabled>
                                </select>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                <label class="d-flex align-items-center fs-sm-8 fs-lg-6 fw-bolder mb-1 required">Nomor
                                    SK</label>
                                <input type="text" name="nomor_sk" class="form-control form-control-sm fs-sm-8 fs-lg-6"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" name="tanggal_sk"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="edit_tanggal_sk"
                                    placeholder="Pilih tanggal SK" required>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" name="tanggal_masuk"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="edit_tanggal_masuk"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="number" name="masa_jabatan"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="edit_masa_jabatan"
                                    placeholder="Masukkan masa jabatan" min="0" max="80">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" name="tanggal_keluar"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="edit_tanggal_keluar"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" name="sk_pemberhentian"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="edit_sk_pemberhentian"
                                    placeholder="Masukkan nomor SK pemberhentian" maxlength="50">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                <label class="d-flex align-items-center fs-sm-8 fs-lg-6 fw-bolder mb-1">Alasan
                                    Keluar</label>
                                <textarea name="alasan_keluar" class="form-control form-control-sm fs-sm-8 fs-lg-6"
                                    id="edit_alasan_keluar" placeholder="Masukkan alasan keluar" rows="2"></textarea>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                <label
                                    class="d-flex align-items-center fs-sm-8 fs-lg-6 fw-bolder mb-1">Keterangan</label>
                                <textarea name="keterangan" class="form-control form-control-sm fs-sm-8 fs-lg-6"
