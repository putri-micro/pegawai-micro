                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <select data-control="select2" class="form-select form-select-sm fs-sm-8 fs-lg-6"
                                    id="id_unit" name="id_unit" data-placeholder="Pilih Unit" data-allow-clear="true"
                                    required>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <select data-control="select2" class="form-select form-select-sm fs-sm-8 fs-lg-6"
                                    id="id_jabatan" name="id_jabatan" data-placeholder="Pilih Jabatan"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" name="tanggal_sk"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="tanggal_sk"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" name="tanggal_masuk"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="tanggal_masuk"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="number" name="masa_jabatan"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="masa_jabatan"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" name="tanggal_keluar"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="tanggal_keluar"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" name="sk_pemberhentian"
                                    class="form-control form-control-sm fs-sm-8 fs-lg-6" id="sk_pemberhentian"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <div id="file_sk_masuk_summary" class="mt-1 small text-primary fw-bold"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <div id="file_sk_keluar_summary" class="mt-1 small text-primary fw-bold"
                                    style="display:none;"></div>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
